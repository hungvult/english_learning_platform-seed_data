...
Python script that populates the SQL Server database with initial curriculum
data.
...
- **alice**: lessons 1–4 of _English Unit 1_ (scores 100, 95, 90, 85)
- **bob**: lessons 1–2 of _Tiếng Anh Unit 1_ (scores 100, 90)
...
The seeder waits for SQL Server to be healthy before inserting data. It is
