...
COURSES = [
    {
        ...
        "units": [
            {
                "title": "Unit 1 - At School: Ask for assistant",
                "order": 1,
                "lessons": [
                    ("Ask the Teacher for Help",               "new knowledge", 1),
                    ("Ask a Classmate for Assistant",          "new knowledge", 2),
                    ("Ask for Repetition and Clarification",   "new knowledge", 3),
                    ("Ask for School Supplies",                "new knowledge", 4),
                    ("Review: Asking for Assistant",           "review",        5),
                    ("Test: Asking for Assistant",             "test",          6),
                ],
            },
            {
                "title": "Unit 2 - At School: Do Exercise",
                "order": 2,
                "lessons": [
                    ("Understand Exercise Instructions",       "new knowledge", 1),
                    ("Do Grammar Exercises",                  "new knowledge", 2),
                    ("Do Vocabulary Exercises",               "new knowledge", 3),
                    ("Check and Correct Answers",             "new knowledge", 4),
                    ("Review: Do Exercise",                   "review",        5),
                    ("Test: Do Exercise",                     "test",          6),
                ],
            },
        ],
    },
        ...
        "units": [
            {
                ...
                "lessons": [
                    ...
                    ("Ôn tập: Chào hỏi",            "review",        3),
                    ("Xin mời",                     "new knowledge", 4),
                    ("Màu sắc & Hình dạng",         "new knowledge", 5),
